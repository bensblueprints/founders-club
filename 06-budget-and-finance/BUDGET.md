# Budget & Unit Economics — Da Nang Pilot

_Fill in real numbers on/after the call. Figures below are placeholder estimates to frame the conversation._
...
| Ticket price | $150 |
| Cap | 25 |
| **Max gross revenue** | **$3,750** |

At a realistic pilot fill of, say, 15 paid: **$2,250**.

## Cost estimate (Da Nang — updated with real inputs)
| Item | Cost | Notes |
|---|---|---|
...
**Principle: costs come off the top first, then split the net.**
1. All shared costs (venue, app, ads, fees, printing) are reimbursed from ticket revenue *before* anyone takes profit.
2. **Net profit split 3 ways, equally** (Maddy / An / Benji) — proposed instead of Benji's earlier 50 / (Maddy+An 50).

### Why 3-way equal (Maddy's position to raise)
