...
-- One-time links for existing accounts. Raw tokens are never stored.
-- ========================================
...
CREATE TABLE IF NOT EXISTS event_attendance (
    ...
    meal_order JSONB,
    meal_subtotal_vnd BIGINT NOT NULL DEFAULT 0,
    meal_vat_vnd BIGINT NOT NULL DEFAULT 0,
    meal_service_vnd BIGINT NOT NULL DEFAULT 0,
    meal_total_vnd BIGINT NOT NULL DEFAULT 0,
    meal_credit_vnd BIGINT NOT NULL DEFAULT 750000,
    meal_amount_due_vnd BIGINT NOT NULL DEFAULT 0,
    meal_submitted_at TIMESTAMP WITH TIME ZONE,
    meal_updated_at TIMESTAMP WITH TIME ZONE,
