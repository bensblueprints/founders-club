...
const UPCOMING_EVENTS = [
    // ===== JULY 2026 =====
    {
        ...
        location: 'FOR YOU SteakHouse, Esco Beach, Da Nang',
        address: 'Esco Beach, Da Nang, Vietnam',
        description: "Join us for an exclusive evening at FOR YOU SteakHouse on Esco Beach. Doors open at 6 PM with a meet & greet over hors d'oeuvres and welcome drinks, followed by a 30-minute open mingle, rapid-fire 1-minute founder intros, and an intimate dinner with Founder Bingo played across the tables.",
        capacity: 60,
        dinnerCapacity: 60,
        spotsRemaining: 60,
